...
class WorkloadStore:
    ...
    def load_workloads_from_json(self, json_list):
        for json_item in json_list:
            ...
            pylo.log.debug("Found Workload '%s' with href '%s'", new_item_name, new_item_href)
    ...
    def find_workload_matching_forced_name(self, name: str, case_sensitive: bool = True, strip_fqdn: bool = False) -> Optional[pylo.Workload]:
        """

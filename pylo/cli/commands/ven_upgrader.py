...
def __main(args, org: pylo.Organization, **kwargs):
    ...
    version_count = {}
    for agent in org.VENAgentStore.items_by_href.values():
    ...
    print("    - TOTAL: {} Agents".format(len(org.VENAgentStore.items_by_href)))
    ...
    agents = org.VENAgentStore.items_by_href.copy()
